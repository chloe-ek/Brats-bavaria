  ...
  return (
    <footer className="flex justify-center px-4 pt-10 pb-6">
      <div className="flex max-w-[1400px] flex-1 flex-col text-center text-[#9daeb8]">
        ...
        <Link href="/privacy" className="text-base font-normal min-w-40 hover:underline">Privacy Policy</Link>
        <Link href="/terms" className="text-base font-normal min-w-40 hover:underline">Terms of Service</Link>
        <Link href="/#contact" className="text-base font-normal min-w-40 hover:underline">Contact Us</Link>
        </div>
