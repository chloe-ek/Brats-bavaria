  ...
  return (
    <div className="relative w-full bg-[#111518]">
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-6 md:px-20 lg:px-40 py-24 text-white">
        <h1 className="text-6xl font-bold mb-4 font-Ovo text-center w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center">
          ...
          <div className="flex flex-col justify-center text-white">
            <h2 className="text-xl font-semibold mb-6 font-Ovo">
            ...
            <p className="text-md font-Ovo font-bold">
