      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            {events.map((event, index) => {
              ...
              return (
                <div key={index} className="flex items-start gap-6">
                  <div className="flex flex-col items-center justify-center w-20 h-20 bg-[#1c2333] border border-[#465171] text-sm font-bold">
                    <span>{day}</span>
                    <span>{month}</span>
                    <span>{year}</span>
                  </div>
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-4">
            {['/showcase.png', '/showcase.png', '/showcase.png', '/showcase.png'].map((src, i) => (
