...
export default function TermsOfService() {
    return (
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className="text-lg sm:text-xl font-semibold mt-6 mb-2">Eligibility</h2>
        <p className="mb-4">
          All submissions are subject to review and approval. Submission does not guarantee participation in the event.
        </p>
  
        <h2 className="text-lg sm:text-xl font-semibold mt-6 mb-2">Photo Usage</h2>
        <p className="mb-4">
        ...
        <h2 className="text-lg sm:text-xl font-semibold mt-6 mb-2">Code of Conduct</h2>
        <p className="mb-4">
        ...
        <h2 className="text-lg sm:text-xl font-semibold mt-6 mb-2">Changes</h2>
        <p className="mb-4">
